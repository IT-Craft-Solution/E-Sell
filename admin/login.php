...
<head>
  ...
  <title>E-Sell Admin Login</title>
  <!-- plugins:css -->
          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left p-5">
              ...
              <form class="pt-3" method="post">
                ...
                <div class="mt-3">
                  <input type="submit" style="background:#0000FF" class="btn btn-block  btn-lg font-weight-medium auth-form-btn" value="LOGIN" name="submit"/>
                </div>
