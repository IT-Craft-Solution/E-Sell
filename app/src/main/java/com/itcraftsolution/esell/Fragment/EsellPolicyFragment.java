...
//        binding.wbEsellPolicy.setWebViewClient(new WebViewClient());
//        binding.wbEsellPolicy.getSettings().setSupportZoom(true);
//        binding.wbEsellPolicy.loadUrl(ApiUtilities.EsellServicePolicy);
